        ...
        {isOpen && (
          <div className="fixed ">
            <div className="fixed top-0 right-0 w-full h-full section-bg-color text-white shadow-lg transform translate-x-0 transition-transform duration-300 py-6">
                ...
                {navData.map((item, index) => {
                  return (
                    <div
                      ...
                      } border-b section-bg-color p-[20px]`}
                    >
                      {item.name}
                    </div>
                  );
              ...
              <div className="md:mt-0 mt-[20px] sm:mx-0 mx-[20px]">
                <Button text="Log in" />
              </div>
              <div className="md:hidden fixed bottom-[20px] flex gap-[20px] items-center md:mt-0 mt-[20px] md:mx-0 mx-[20px]">
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
